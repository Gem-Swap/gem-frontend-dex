...
1. Fork the [GemSwap Dex Frontend](https://github.com/Gem-Swap/gem-frontend-dex/) repository on GitHub
...
3. Add your **token information** using the example format provided below to `gemswap.json` in the `/src/constants/token/` directory.
...
"name": "Gemswap",
"symbol": "GSP",
"address": "0xE5cD504D3c1a0a3E3E2faafdcd611BA6a30f427b",
"chainId": 56,
"decimals": 18,
"logoURI": "/images/coins/GSP.png"
},
```

If you're not comfortable with GitHub pull requests, please open a [new issue](https://github.com/Gem-Swap/gem-frontend-dex/issues/new) requesting to be added.
